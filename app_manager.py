...
def on_message(client, userdata, msg):
    ...
    if float(m_decode.split(': ')[1]) < gas_weight_THR:
        ic("Threshold warning! You might consider replacing a gas cylinder. The gas weght is: " + m_decode.split(': ')[1])
        send_msg(client, topic_alarm, "Threshold warning! You might consider replacing a gas cylinder. The gas weght is: " + m_decode.split(': ')[1])
